...
class Screen:
	...
	def __init__(self, width = 800, height = 600, background_color = Color.BG_COLOR, font_type = "monospac", font_size = 35, clock_tick = 30):
	...
	def draw_enemies(self, enemy_list): #Use player class to help with basic functions
